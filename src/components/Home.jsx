...
import Dp from "../assets/sameerk.jpg"
            ...
            <div className='max-w-screen-lg mx-auto flex flex-col items-center
                ...
                <div className='flex flex-col justify-center'>
                    ...
                    <div className='flex flex-row gap-2'>
                        ...
                        <a target='_blank' rel="noreferrer"  href="mailto:khajamoinuddinsameer@gmail.com" smooth duration={500} data-aos="fade-up" data-aos-delay="1000" data-aos-duration="2500" className='group hover:scale-105 rounded w-auto h-8 p-3 flex items-center bg-gradient-to-r from-indigo-600 via-purple-600 to-orange-600 justify-center cursor-pointer mt-5 mb-28' >
                        ...
                        <a target='_blank' rel="noreferrer" href="https://www.linkedin.com/in/khaja-moinuddin-687196275/" smooth duration={550} data-aos="fade-up" data-aos-delay="2000" data-aos-duration="3000" className='group hover:scale-105 rounded w-auto h-8 px-1 flex items-center bg-none justify-center cursor-pointer mt-5 mb-28' >

                            <span >
                            <BsLinkedin size={25}></BsLinkedin>
                            </span>
                        </a>
                        <a target='_blank' rel="noreferrer" href="https://github.com/khajamoinuddin26" smooth duration={600} data-aos="fade-up" data-aos-delay="3000" data-aos-duration="3500" className='group hover:scale-105 rounded w-auto h-8 px-1 flex items-center bg-none justify-center cursor-pointer mt-5 mb-28' >
