    ...
    >
      ...
      >
        <div className="flex flex-col justify-center">
          ...
          >
            I'm a B.Tech 4th year Student of Vignan Institute of Technology and
            Science, Hyderabad. I specialize in Data Structures and Algorithms
            (DSA) and have extensive experience in development using languages
            like Python, Java, Javascript, HTML, and MySQL. With a proactive
            approach to learning and a keen interest in staying updated with
            emerging trends and technologies, I am committed to furthering my
            skills and contributing meaningfully to the ever-evolving landscape
          ...
          <div className="flex flex-row gap-2">
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="mailto:khajamoinuddinsameer@gmail.com"
              smooth
              duration={500}
              data-aos="fade-up"
              data-aos-delay="800"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.linkedin.com/in/khaja-moinuddin-687196275/"
              smooth
              duration={550}
              data-aos="fade-up"
              data-aos-delay="1000"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/khajamoinuddin26"
              smooth
              duration={600}
              data-aos="fade-up"
              data-aos-delay="1100"
